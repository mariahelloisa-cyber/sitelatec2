        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <a href={contato.linkedin_url || '#'} target="_blank" rel="noreferrer" aria-label="LinkedIn" className="w-8 h-8 rounded-full border border-[#cd146e]/40 text-[#cd146e] flex items-center justify-center hover:bg-[#cd146e] hover:text-white hover:border-[#cd146e] transition-colors">
