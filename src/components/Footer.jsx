        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2.5">
              <a href={urlSegura(contato.instagram_url)} target="_blank" rel="noreferrer" aria-label="Instagram" className="w-8 h-8 rounded-full border border-[#cd146e]/40 text-[#cd146e] flex items-center justify-center hover:bg-[#cd146e] hover:text-white hover:border-[#cd146e] transition-colors">
              ...
              <a href={urlSegura(contato.facebook_url)} target="_blank" rel="noreferrer" aria-label="Facebook" className="w-8 h-8 rounded-full border border-[#cd146e]/40 text-[#cd146e] flex items-center justify-center hover:bg-[#cd146e] hover:text-white hover:border-[#cd146e] transition-colors">
          ...
          <div className="md:col-span-5 md:border-l md:border-gray-200 md:pl-8 flex flex-col gap-2.5">
            ...
            <ul className="flex flex-col gap-2 text-sm">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href={urlSegura(`mailto:${contato.email}`)} className="hover:text-[#cd146e] transition-colors">
                  {contato.email}
                </a>
              </li>
            </ul>
